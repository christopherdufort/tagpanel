        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ url('/dashboard/locations') }}">Locations</a></li>
                    <li class="active">Edit Existing Location</li>
                </ol>
            </div>
        </div>

        <!-- The data encoding type, enctype, MUST be specified as below -->
        <form class="well form-horizontal" action="{{ url('location/update') }}" method="post"  id="location_form" enctype="multipart/form-data">
            {{ csrf_field() }}
            <fieldset>

                <!-- Form Name -->
                <legend>Anything Left Blank when modifying this existing location will remain unchanged.</legend>

                <input type="hidden" name="location_id" value="{{$location->id}}" readonly>
